...
*/
  ...
  function removeItem (myGroceryList, itemToRemove) {
    ...
    var remove = myGroceryList.indexOf(itemToRemove)
  } else {
    var remove = -1;
  }
      if (remove !== -1) {
        myGroceryList.splice(remove, 1);
      }
      if (Array.isArray(myGroceryList)) {
...
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/
  ...
  if (i === devMountainEmployees.indexOf(cahlan)) {
...
var user2 = {
  name: 'Bruce Wayne',
  email: 'BWayne@NotBatman.com',
  password: 'totallynotbatman',
  username: 'NotEvenALittleBatman'
}
var user3 = {
  name: 'Clark Kent',
  email: 'CKent@DailyBugle.com',
  password: 'Supermanrox',
  username: 'ManOfSteel'
}
